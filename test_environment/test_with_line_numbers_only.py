#!/usr/bin/env python3
"""
Test the coding agent with proper line numbers (no o3).
"""
...
async def test_with_line_numbers():
    """Test the Coding Agent with line numbers in context."""
    
    # Setup logging
    setup_logging(logging.INFO)
    
    print("\n=== Testing with Line Numbers in Context ===\n")
    ...
    # LLM Client
    llm_client = LLMClient()  # Will use default model
    ...
    # Don't disable linters/tests to see if line numbers alone help
    
    # Test task
    print("\n📝 Creating test task...")
    
    task = messages_pb2.CodingTask()
    task.id = "test-lines-001"
    ...
    # Debug: Show context format first
    print("\n🔍 Context format being provided:")
...
if __name__ == "__main__":
    asyncio.run(test_with_line_numbers())